/**
  ...
  * @brief   The web server content (pages) and request processing
  ******************************************************************************
  */
  ...
  if (recv_err == ERR_OK)
  {
    if (netconn_err(conn) == ERR_OK) 
    {
      ...
      if ((buflen >=5) && (strncmp(buf, "GET /", 5) == 0))
      {
        ...
        if (strncmp((char const *)buf,"GET /STM32F7xx_files/logo.jpg", 29) == 0)
        {
        ...
        else if((strncmp(buf, "GET /VolDown.html", 17) == 0)||(strncmp(buf, "GET / ", 6) == 0))
        {
          /* link/button Volume Down pressed */
          BSP_LED_On(LED1);
          BSP_LED_Off(LED2);
          AUDIO_Volume(0);		//down by 10

          file = fs_open("/STM32F7xx.html");
          netconn_write(conn, (const unsigned char*)(file->data), (size_t)file->len, NETCONN_NOCOPY);
          fs_close(file);
        }
        else if((strncmp(buf, "GET /VolUp.html", 15) == 0)||(strncmp(buf, "GET / ", 6) == 0))
        {
          /* link/button Volume Down pressed */
          BSP_LED_Off(LED1);
          BSP_LED_On(LED2);
          AUDIO_Volume(1);		//up by 10
