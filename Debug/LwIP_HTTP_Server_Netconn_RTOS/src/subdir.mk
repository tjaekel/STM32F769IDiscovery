...
LwIP_HTTP_Server_Netconn_RTOS/src/%.o LwIP_HTTP_Server_Netconn_RTOS/src/%.su: ../LwIP_HTTP_Server_Netconn_RTOS/src/%.c LwIP_HTTP_Server_Netconn_RTOS/src/subdir.mk
...
clean-LwIP_HTTP_Server_Netconn_RTOS-2f-src:
	-$(RM) ./LwIP_HTTP_Server_Netconn_RTOS/src/app_ethernet.d ./LwIP_HTTP_Server_Netconn_RTOS/src/app_ethernet.o ./LwIP_HTTP_Server_Netconn_RTOS/src/app_ethernet.su ./LwIP_HTTP_Server_Netconn_RTOS/src/ethernetif.d ./LwIP_HTTP_Server_Netconn_RTOS/src/ethernetif.o ./LwIP_HTTP_Server_Netconn_RTOS/src/ethernetif.su ./LwIP_HTTP_Server_Netconn_RTOS/src/fs.d ./LwIP_HTTP_Server_Netconn_RTOS/src/fs.o ./LwIP_HTTP_Server_Netconn_RTOS/src/fs.su ./LwIP_HTTP_Server_Netconn_RTOS/src/httpserver-netconn.d ./LwIP_HTTP_Server_Netconn_RTOS/src/httpserver-netconn.o ./LwIP_HTTP_Server_Netconn_RTOS/src/httpserver-netconn.su ./LwIP_HTTP_Server_Netconn_RTOS/src/main_http.d ./LwIP_HTTP_Server_Netconn_RTOS/src/main_http.o ./LwIP_HTTP_Server_Netconn_RTOS/src/main_http.su
