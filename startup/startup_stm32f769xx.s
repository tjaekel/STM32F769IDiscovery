/**
  ...
  * @brief   The startup code (assemblye code)
  ******************************************************************************
  */
    
  .syntax unified
  .cpu cortex-m7
  /* ATT: align with the command line -mfpu=fvp5-d16 ! */
  /*.fpu softvfp*/
  .fpu fpv5-d16
  .thumb
...
1:
	//ATT: Length cannot be 0 on call !!
	ldmia.w r1!, {r4, r5, r6, r7, r8, r9, r10, r11}
	stmia.w r0!, {r4, r5, r6, r7, r8, r9, r10, r11}
	//roll out a bit
	ldmia.w r1!, {r4, r5, r6, r7, r8, r9, r10, r11}
	stmia.w r0!, {r4, r5, r6, r7, r8, r9, r10, r11}
	subs r2, #64
...
*/
    ...
    //we can end up here also with HardFault_Handler called - why?
Default_Handler:
Infinite_Loop:
  	b  Infinite_Loop
